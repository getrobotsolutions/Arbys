...
$('input:radio[name="rating"]').change(function(e){
    ...
    var craft = $('input:radio[name=craft]:checked').val();
    //alert(radioValue);
    if (craft==null) {
      alert("Please Select an option3.");
      //$("#visit").focus();
      return false;
    }
    var breakout = $('input:radio[name=breakout]:checked').val();
    //alert(radioValue);
    if (breakout==null) {
      alert("Please Select an option4.");
      //$("#visit").focus();
      return false;
    }
    e.preventDefault();
